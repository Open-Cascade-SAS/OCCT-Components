...
#ifndef _DEDXF_ConfigurationNode_HeaderFile
#define _DEDXF_ConfigurationNode_HeaderFile

#include <DE_ConfigurationNode.hxx>

#include <DxfSection_ConfParameters.hxx>

//! The purpose of this class is to configure the transfer process for DXF format
//! Stores the necessary settings for DEDXF_Provider.
//! Configures and creates special provider to transfer DXF files.
//!
//! Nodes grouped by Vendor name and Format type.
//! The Vendor name is "OCC"
//! The Format type is "DXF"
//! The supported CAD extension is ".dxf"
//! The import process is supported.
//! The export process is supported.
class DEDXF_ConfigurationNode : public DE_ConfigurationNode
{
  DEFINE_STANDARD_RTTIEXT(DEDXF_ConfigurationNode, DE_ConfigurationNode)
public:
  //! Initializes all fields by default
  Standard_EXPORT DEDXF_ConfigurationNode();

  //! Copies values of all fields
  //! @param[in] theNode object for copy
  Standard_EXPORT DEDXF_ConfigurationNode(const Handle(DEDXF_ConfigurationNode)& theNode);
...
public:
  DxfSection_ConfParameters InternalParameters; //<! Customize transfer process parameters
...
#endif // _DEDXF_ConfigurationNode_HeaderFile
