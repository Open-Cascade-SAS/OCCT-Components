...
#ifndef _TKDEDXF_HeaderFile
#define _TKDEDXF_HeaderFile

#include <Standard_Macro.hxx>
#include <TCollection_AsciiString.hxx>

//! Interface to activate license for TKDEDXF toolkit
...
public:
  ...
  //! @param[in] theLicenseDXF license key or path to DXF license file or license server
  Standard_EXPORT static void Activate(const TCollection_AsciiString& theLicenseDXF);
