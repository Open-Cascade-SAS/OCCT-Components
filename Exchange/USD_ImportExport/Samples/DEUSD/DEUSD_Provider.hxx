...
#ifndef _DEUSD_Provider_HeaderFile
#define _DEUSD_Provider_HeaderFile

#include <DE_Provider.hxx>

//! The class to transfer USD files.
//! Reads and Writes any USD files into/from OCCT.
...
class DEUSD_Provider : public DE_Provider
{
public:
  DEFINE_STANDARD_RTTIEXT(DEUSD_Provider, DE_Provider)

public:
  //! Default constructor
  //! Configure translation process with global configuration
  Standard_EXPORT DEUSD_Provider();

  //! Configure translation process
  //! @param[in] theNode object for initializing Internal Parameters
  Standard_EXPORT DEUSD_Provider(const Handle(DE_ConfigurationNode)& theNode);
