...
#ifndef _DERVM_Provider_HeaderFile
#define _DERVM_Provider_HeaderFile

#include <DE_Provider.hxx>

//! The class to transfer RVM files.
//! Reads and Writes any RVM files into/from OCCT.
...
class DERVM_Provider : public DE_Provider
{
public:
  DEFINE_STANDARD_RTTIEXT(DERVM_Provider, DE_Provider)

public:
  //! Default constructor
  //! Configure translation process with global configuration
  Standard_EXPORT DERVM_Provider();

  //! Configure translation process
  //! @param[in] theNode object for initializing Internal Parameters
  Standard_EXPORT DERVM_Provider(const Handle(DE_ConfigurationNode)& theNode);
...
#endif // _DERVM_Provider_HeaderFile
