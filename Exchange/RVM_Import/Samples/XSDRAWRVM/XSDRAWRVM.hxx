...
#ifndef _XSDRAWRVM_HeaderFile
#define _XSDRAWRVM_HeaderFile

#include <Standard.hxx>

class Draw_Interpretor;

//! XSDRAW for RVM interface
class XSDRAWRVM
{
public:
  ...
  //! Loads RVM interface commands into the Draw interpretor
  Standard_EXPORT static void InitCommands(Draw_Interpretor& theCommands);

  //! Loads all Draw commands of TKXSDRAWRVM. Used for plugin.
