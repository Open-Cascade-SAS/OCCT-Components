...
#ifndef _DESAT_Provider_HeaderFile
#define _DESAT_Provider_HeaderFile
...
//! The class to transfer SAT files.
//! Reads and Writes any SAT files into/from OCCT.
...
class DESAT_Provider : public DE_Provider
{
public:
  DEFINE_STANDARD_RTTIEXT(DESAT_Provider, DE_Provider)

public:
  //! Default constructor
  //! Configure translation process with global configuration
  Standard_EXPORT DESAT_Provider();

  //! Configure translation process
  //! @param[in] theNode object for initializing Internal Parameters
  Standard_EXPORT DESAT_Provider(const Handle(DE_ConfigurationNode)& theNode);
...
#endif // _DESAT_Provider_HeaderFile
