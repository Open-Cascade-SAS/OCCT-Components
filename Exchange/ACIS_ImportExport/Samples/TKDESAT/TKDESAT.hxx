...
#ifndef _TKDESAT_HeaderFile
#define _TKDESAT_HeaderFile

#include <Standard_Macro.hxx>
#include <TCollection_AsciiString.hxx>

//! Interface to activate license for TKDESAT toolkit
...
public:
  ...
  //! @param[in] theLicenseSAT license key or path to SAT license file or license server
  Standard_EXPORT static void Activate(const TCollection_AsciiString& theLicenseSAT);

  //! Activates the application license for a current product by a key string or license path or server.
  //! The call should be made prior to usage of the corresponding product.
  //! Only the one call name will be accepted.
  //! @param[in] theLicenseSAT license key or path to SAT license file or license server
  //! @param[in] theLicenseACIS license key or path to ACIS license file or license server
  Standard_EXPORT static void Activate(const TCollection_AsciiString& theLicenseSAT,
                                       const TCollection_AsciiString& theLicenseACIS);
